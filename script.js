...
const projects = [
 ...
 {
    id: 1,
    title: "منصة نادي لحاف (مكتمل)",
    shortDesc: " منصة سعودية تجمع اللعب الجيزاني (التراث الجنوبي) في منصة واحدة ",
    fullDesc: "منصة تعرض مقاطع فيديو وصور توضح كيفية اللعب القديم أيضا امكانية حجز مواعيد لإحياء المناسبات ، إمكانية ارسال طلب للإنضمام الى فريق المنصة ",
    // ===== رابط المشروع - عدّل الرابط هنا =====
    link: "https://lhaf.site/",
    // ===== الأيقونة/الإيموجي التعبيري للمشروع =====
    icon: "",
    // ===== صور المشروع في الـ Gallery - أضف مساراتها هنا =====
    // مثال: "assets/images/gym-1.jpg"
    gallery: ["assets/images/img60.png", "assets/images/img61.png", "assets/images/img62.png", "assets/images/img63.png"],
    // ===== التقنيات المستخدمة =====
   tags: ["HTML5", "CSS3", "JavaScript", "PHP","MYSQL"],
  },
 ...
 {
    id: 1,
    title: "منصة نظام مدرسي (مكتمل)",
    shortDesc: " منصة تربط المعلمين والإداريين مع أولياء الأمور في منصة واحدة ",
    fullDesc: "منصة تهدف الى اطلاع ولي الأمر بكل مهام الطالب المدرسية من واجبات الكترونية او اختبارات أيضا درجات الطالب ، الخطة الاسبوعية ، امكانية ارفاق ملاحظات أسبوعية لكل طالب ترسل بشكل الكتروني ، امكانية انشاء اجتماعات اونلاين او حصص عن بعد ، امكانية ارسال طلب استئذان من ولي الامر للطالب ، وأكثر  ",
    // ===== رابط المشروع - عدّل الرابط هنا =====
    link: "",
    // ===== الأيقونة/الإيموجي التعبيري للمشروع =====
    icon: "",
    // ===== صور المشروع في الـ Gallery - أضف مساراتها هنا =====
    // مثال: "assets/images/gym-1.jpg"
    gallery: ["assets/images/img68.png", "assets/images/img69.png", "assets/images/img70.png", "assets/images/img71.png"],
    // ===== التقنيات المستخدمة =====
   tags: ["HTML5", "CSS3", "JavaScript", "PHP","MYSQL"],
  },
 ...
 {
    id: 10,
    title: "موقع إلكتروني توليد جداول للمعملين (مكتمل)",
...

 {
  ...
  },
  {
    ...
    tags: ["HTML5", "CSS3", "JavaScript", "Arabic"],
     ...
     {
    id: 8,
    title: "منصة عقار (قيد التطوير)",
    shortDesc: "منصة عقار متكاملة تهدف إلى تسهيل الوصول إلى العقارات بأنواعها.",
    fullDesc: "منصة عقار تهدف إلى تسهيل التواصل بين البائع وبين العميل بتجربة مستخدم سهلة وسريعة مع وجود مزايا بالذكاء الإصطناعي غير موجوده في السوق مسبقًا.", 
    link: "#",
    icon: "",
